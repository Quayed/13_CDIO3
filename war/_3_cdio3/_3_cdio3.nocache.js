...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "_3_cdio3" because\n';
  ...
  $wnd.__gwt_activeModules['_3_cdio3'] = {
    'moduleName' : '_3_cdio3',
    'bindings' : function() {
      return {};
    }
 ...
 * "/_3_cdio3.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['_3_cdio3'].superdevmode = true;

  var expectedSuffix = '/_3_cdio3.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + _3_cdio3 + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:_3_cdio3';
  var devModeSessionKey = '__gwtDevModeSession:_3_cdio3';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/_3_cdio3/_3_cdio3.nocache.js';
  ...
  $wnd.__gwt_activeModules['_3_cdio3'].canRedirect = true;
  $wnd.__gwt_activeModules['_3_cdio3'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/_3_cdio3?user.agent=' + ua + '&_callback=' + callback;
